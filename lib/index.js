...
Oauth3.CLI = CLI;
Oauth3.CLI._wsInit = wsInit;
Oauth3.CLI._writePrompt = writePrompt;
Oauth3.CLI._handleInput = handleInput;
Oauth3.CLI._ccInit = ccInit;
Oauth3.CLI._addressInit = addressInit;
Oauth3.CLI._getCards = getCards;
Oauth3.CLI._getMailingAddress = getMailingAddress;
Oauth3.CLI._getOrCreateMailingAddress = getOrCreateMailingAddress;

...
var Accounts = module.exports.Accounts = {};
Accounts.list = function (options) {
  return module.exports.login(options).then(function (state) {
    return A3.requests.accounts(state.oauth3, state.session);
  });
};
...
Cards.list = function (options) {
  return module.exports.login(options).then(function (state) {
    return A3.requests.cards(state.oauth3, state.session);
  });
};
...
module.exports.dnsToken = module.exports.domainsToken = function (options) {
  options = options || {};

  return module.exports.login(options).then(function (state) {
    // TODO cache token on disk
    return A3.requests.createDomainToken(state.oauth3, state.session, options);
  });
};

module.exports.allDns = function (options) {
  return module.exports.login(options).then(function (state) {
    return A3.requests.getAccountRecords(state.oauth3, state.session);
  });
};

module.exports.getDns = function (options) {
  return module.exports.login(options).then(function (state) {
    var domainname = options.domain || options.name || options.domainname;

    return getDomainPartsAsync(domainname).then(function (parts) {
      return A3.requests.getDomainRecords(state.oauth3, state.session, parts);
    });
  });
};

module.exports.updateDns = function (options) {
  var domainname = options.domain || options.name || options.domainname;
  ...
  if (options.token) {
    ...
    p = module.exports.domainsToken(options);
  }
...
module.exports.removeDns = function (options) {
  var domainname = options.domain || options.name || options.domainname;
  ...
  return getDomainPartsAsync(domainname).then(function (domainparts) {
    ...
    return module.exports.login(options).then(function (state) {
      ...
      return A3.requests.unsetDomainRecord(state.oauth3, state.session, opts2);
    });
  });
};

module.exports.getDevices = function (options) {
  return module.exports.login(options).then(function (state) {
    return A3.requests.getDevices(state.oauth3, state.session);
  });
};

module.exports.setDevice = function (options) {
  ...
  return module.exports.login(options).then(function (state) {
    ...
    return A3.requests.setDevice(state.oauth3, state.session, options);
  });
};

module.exports.deleteDevice = function (options) {
  // options = { addresses, devicename }
  options.devicename = options.devicename || options.device || options.name;
  ...
  return module.exports.login(options).then(function (state) {
    return A3.requests.deleteDevice(state.oauth3, state.session, options);
  });
};

module.exports.detachDevice = function (options) {
  // options = { addresses, devicename }
  options.devicename = options.devicename || options.device || options.name;
  ...
  return getDomainPartsAsync(options.domain).then(function (domainparts) {
    ...
    return module.exports.login(options).then(function (state) {
      return A3.requests.detachDevice(state.oauth3, state.session, options);
    });
  });
};

module.exports.addDeviceToDomain = function (options) {
  ...
  return getDomainPartsAsync(options.domain).then(function (domainparts) {
    ...
    return module.exports.login(options).then(function (state) {
      return A3.requests.addDeviceToDomain(state.oauth3, state.session, options);
    });
  });
};

...
CLI.readInputMailingAddressAsync = function (ws, state) {
  return new PromiseA(function (resolve) {
    return CLI._readInputMailingAddress(ws, state, resolve);
  });
};

CLI._readInputMailingAddress = function (ws, state, cb) {
  var msgs = [
...
CLI.readCreditCardAsync = function (ws, state) {
  return new PromiseA(function (resolve) {
    state.unmask = true;
...
CLI.printQrAsync = function (ws, state) {
  var url;
...
CLI.verifyQrAsync = function (ws, state) {
  state.error = null;
...
CLI.readProviderUrlAsync = function (ws, state) {
...
CLI.readCredentialIdAsync = function (ws, state) {
  state.state = 'login';
  state.msgs = [
...
CLI.readTotpTokenAysnc = function (ws, state) {
  if (state.totpKey) {
...
CLI.readNewCredentialSecretAsync = function (ws, state) {
  state.state = 'secret';
  state.msgs = [
...
CLI.readCredentialSecretAsync = function (ws, state) {
  state.state = 'secret';
  state.msgs = [
...
CLI.readCredentialOtpAsync = function (ws, state) {

...
A3.requests.cards = function (directive, session) {
...
A3.requests.addresses = function (directive, session) {
...
A3.requests.phones = function (directive, session) {
...
A3.requests.emails = function (directive, session) {
...
A3.requests.emails.create = A3.requests.createEmail = function (directive, session, opts) {
...
A3.requests.devices = {};
A3.requests.devices.all = A3.requests.getDevices = function (directive, session) {
  var dir = directive.devices || {
    method: 'GET'
  , url: 'https://' + directive.provider_url + '/api/com.enom.reseller/accounts/:accountsId/devices'
  , bearer: 'Bearer'
  };
  var url = dir.url
    .replace(/:accountId/, session.acx)
...
A3.requests.devices.set = A3.requests.setDevice = function (directive, session, opts) {
  var dir = directive.devices || {
    method: 'POST'
...
A3.requests.devices.detach = A3.requests.detachDevice = function (directive, session, opts) {
  var dir = directive.devices || {
    method: 'DELETE'
...
A3.requests.devices.destroy = A3.requests.deleteDevice = function (directive, session, opts) {
  var dir = directive.devices || {
    method: 'DELETE'
  , url: 'https://' + directive.provider_url + '/api/com.enom.reseller/accounts/:accountId/devices/:name'
  , bearer: 'Bearer'
...
A3.requests.devices.attach = A3.requests.addDeviceToDomain = function (directive, session, opts) {
  var dir = directive.devices || {
    method: 'POST'
  , url: 'https://' + directive.provider_url

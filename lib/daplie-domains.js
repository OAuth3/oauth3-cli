exports.init = function (A3) {
  ...
  A3.requests.domains.release = function (directive, session, opts) {
    var dir = directive.purchaseDomains || {
      method: 'DELETE'
    , url: 'https://' + directive.provider_url + '/api/com.enom.reseller/accounts/:accountId/registrations/:tld/:sld'
    , bearer: 'Bearer'
    };
    var url = dir.url
      .replace(/:accountId/, session.acx)
